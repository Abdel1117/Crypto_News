  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => {
            if (window.confirm("Réinitialiser le portefeuille ? Toutes les positions et l'historique seront perdus.")) {
              dispatch(resetSimulation());
            }
          }}
          className="text-sm px-3 py-1.5 rounded-lg border border-border text-muted-foreground hover:text-foreground hover:border-red-500 transition-colors"
        >
          Réinitialiser
        </button>
      </div>
